  ...
  return (
    <div className="navbar sticky top-0 bg-black text-white w-full h-[10vh] flex justify-between items-center px-4">
      ...
      <div className="left flex items-center gap-4">
        {/* Logo */}
        <div className="icon bg-neutral-900 h-10 w-10 rounded-full p-1 flex items-center justify-center">
          <img src="/images/svg/icon.svg" alt="Logo" className="h-full" />
        </div>

        {/* Home Button */}
        <div className="home bg-neutral-900 h-10 w-10 rounded-full p-1 hover:cursor-pointer hover:scale-110 flex items-center justify-center transition">
          <img src="/images/svg/home.svg" alt="Home" className="h-full" />
        </div>

        {/* Searchbar */}
        <div className="searchbar flex items-center bg-neutral-900 rounded-full px-2 py-1 transition-all duration-500 ease-in hover:bg-neutral-900 gap-2">
          <img
